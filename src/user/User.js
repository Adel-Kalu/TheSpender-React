...
export default class Spend extends Component {
    ...
    render() {
        return (
            ...
            {(this.props.emailAddress === this.props.email) ?(
            ...
            <div>      
                 ...
                 <Button variant="primary" currentPassword = {this.props.password} onClick={()=>{this.props.editView(this.props.id)}}>Edit Profilo</Button>  
             </div>
