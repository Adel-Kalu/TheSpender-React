    ...
    render() {
        ...
        return (
            <div>
                ...
                <Container>
                    <Form.Group>
                        <Form.Control type="text" name="firstName" placeholder="Enter your First Name" onChange={this.changeHandler} required></Form.Control>
                    </Form.Group>

                    <Form.Group>
                        <Form.Control type="text" name="lastName" placeholder="Enter your Last Name" onChange={this.changeHandler} required></Form.Control>
                    </Form.Group>

                    <Form.Group>
                        <Form.Control type="email" name="emailAddress" placeholder="Enter your Email Address" onChange={this.changeHandler} required></Form.Control>
                    </Form.Group>
